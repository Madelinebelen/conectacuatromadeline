 ...
 */
public class multijugador extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.uno = (ImageButton) findViewById(R.id.uno);
        this.dos = (ImageButton) findViewById(R.id.dos);
        this.tres = (ImageButton) findViewById(R.id.tres);
        this.cuatro = (ImageButton) findViewById(R.id.cuatro);
        this.cinco = (ImageButton) findViewById(R.id.cinco);
        this.seis = (ImageButton) findViewById(R.id.seis);
        this.siete = (ImageButton) findViewById(R.id.siete);
        this.ocho = (ImageButton) findViewById(R.id.ocho);
        this.nueve = (ImageButton) findViewById(R.id.nueve);
        this.diez = (ImageButton) findViewById(R.id.diez);
        this.once = (ImageButton) findViewById(R.id.once);
        this.doce = (ImageButton) findViewById(R.id.doce);
        this.trece = (ImageButton) findViewById(R.id.trece);
        this.catorce = (ImageButton) findViewById(R.id.catorce);
        this.quince = (ImageButton) findViewById(R.id.quince);
        this.diesciseis = (ImageButton) findViewById(R.id.dieciseis);
        this.diecisiete = (ImageButton) findViewById(R.id.diecisiete);
        this.diesciocho = (ImageButton) findViewById(R.id.dieciocho);
        this.diescinueve = (ImageButton) findViewById(R.id.diecinueve);
        this.veinte = (ImageButton) findViewById(R.id.veinte);
        this.veintiuno = (ImageButton) findViewById(R.id.veintiuno);
        this.veintidos = (ImageButton) findViewById(R.id.veintidos);
        this.veintitres = (ImageButton) findViewById(R.id.veintitres);
        this.veinticuatro = (ImageButton) findViewById(R.id.veinticuatro);
        this.veinticinco = (ImageButton) findViewById(R.id.veinticinco);
        this.veintiseis = (ImageButton) findViewById(R.id.veintiseis);
        this.veintisiete = (ImageButton) findViewById(R.id.veintisiete);
        this.veintiocho = (ImageButton) findViewById(R.id.veintiocho);
        this.veintinueve = (ImageButton) findViewById(R.id.veintinueve);
        this.treinta = (ImageButton) findViewById(R.id.treinta);
        this.treintauno = (ImageButton) findViewById(R.id.treintauno);
        this.treintados = (ImageButton) findViewById(R.id.treintados);
        this.treintatres = (ImageButton) findViewById(R.id.treintatres);
        this.treintacuatro = (ImageButton) findViewById(R.id.treintacuatro);
        this.treintacinco = (ImageButton) findViewById(R.id.treintacinco);
    ...
    public void validarganar()
    {
        ...
        if (ganar==true)
        {
            ...
            intent.setClass(multijugador.this, MainActivity.class);
    ...
    public void oponentepersona()
    {
        boolean poner=true;
        int persona=(34);
        while (poner)
        {
            if(tablero[persona]==2 | tablero[persona]==1){
                persona=persona+1;
                if (persona==35)
                {
                    persona=0;
    ...
    public void validarganaroponente()
    {
        if(tablero[0]==2)
        {
            if (tablero[1]==2)
